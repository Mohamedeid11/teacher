...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::resource('users', 'UsersController');
	 ...
	 // Student Info
    Route::delete('student-infos/destroy', 'StudentInfoController@massDestroy')->name('student-infos.massDestroy');
    ...
    Route::put('question-options', 'QuestionOptionsController@update')->name('questionOptions.update');
    Route::get('questionOptions/{id}', 'QuestionOptionsController@delete')->name('questionOptions.delete');
    ...
    // Gifts
    Route::delete('gifts/destroy', 'GiftsController@massDestroy')->name('gifts.massDestroy');
    ...
    Route::get('categoriesType/{cat_type?}', 'CategoryController@index')->name('categoryIndex');
    Route::get('categoryType/{cat_type?}', 'CategoryController@create')->name('categoryCreate');
    Route::get('categoryEditType/{id}/{cat_type?}', 'CategoryController@edit')->name('categoryEdit');
    ...
    // Home Score
    Route::delete('home-scores/destroy', 'HomeScoreController@massDestroy')->name('home-scores.massDestroy');
    Route::resource('home-scores', 'HomeScoreController');
