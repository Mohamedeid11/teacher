...
class TestsController extends Controller
{
    public function index()
    {
        ...
        $tests = Test::with(['course', 'lesson', 'grade'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.tests.create', compact('courses', 'grades', 'lessons'));
    }
    ...
    public function edit(Test $test)
    {
        ...
        return view('frontend.tests.edit', compact('courses', 'grades', 'lessons', 'test'));
    }
